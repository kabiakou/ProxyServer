...
const getRoverPhotosByDate = async (date, apiKey) => {
    return await axios.get(ROVER_PHOTOS_URL, {
        params: {
...
const getRoverManifiest = async (apiKey) => {
    return await axios.get(ROVER_MANIFEST_URL, {
        params: {
            api_key: apiKey
        }
    })
